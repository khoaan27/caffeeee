...
import { calculateCoffeeStats, calculateCurrentCaffeineLevel, coffeeConsumptionHistory,getTopThreeCoffees,statusLevels } from "../ultis"
...
export default function Stats(){
    ...
    const warningLevel= caffeinLevel<statusLevels['low'].maxLevel?'low': caffeinLevel<statusLevels['moderate'].maxLevel?'moderate':'high'
    return(
        <>
